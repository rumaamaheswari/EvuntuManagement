...
CREATE TABLE `EVENT_FACILITY` (
  `EVENT_FACILITY_ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `EVENT_ID` bigint(20) NOT NULL,
  `FACILITY_ID` bigint(20) NOT NULL,
  PRIMARY KEY (`EVENT_FACILITY_ID`),
  KEY `FK_i5gy2lh7j1a35r18c2yv2quj9` (`EVENT_ID`),
  KEY `FK_9if7asbtlk3sekj7kn668rlje` (`FACILITY_ID`),
  CONSTRAINT `FK_9if7asbtlk3sekj7kn668rlje` FOREIGN KEY (`FACILITY_ID`) REFERENCES `FACILITY` (`FACILITY_ID`),
  CONSTRAINT `FK_i5gy2lh7j1a35r18c2yv2quj9` FOREIGN KEY (`EVENT_ID`) REFERENCES `EVENT` (`EVENT_ID`)
...
INSERT INTO `EVENT_FACILITY` VALUES (1,1,1),(2,1,2);
